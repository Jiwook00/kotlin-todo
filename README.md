...
- [x] 24 리스트 - Todo 항목 저장
- [x] 27 맵 - 데이터 구조화
- [x] [28 프로퍼티 접근자 - getter setter](docs/28_프로퍼티%20접근자-getter-setter.md)
### 3부: 사용성 (중요)
- [x] 31 이름 붙은 인자와 디폴트 인자 - 편리한 함수 호출
- [x] 33 when 식 - 메뉴 처리
- [x] [35 데이터 클래스 - Todo 클래스를 더 간결하게](docs/35_데이터-클래스.md) 
- [x] 37~40 널이 될 수 있는 타입 관련 - 안전한 코드 작성 
### 4부: 함수형 프로그래밍 (유용)
- [x] 44 람다 - 간결한 코드 작성
- [x] 46 컬렉션에 대한 연산 - Todo 리스트 필터링, 정렬
### 5부: 객체 지향 프로그래밍 (선택적)
- [x] [55 인터페이스 - 확장 가능한 설계](docs/55_인터페이스.md)
- [ ] 63 합성 - 객체 조합
### 6부: 실패 방지하기 (중요)
- [ ] 73 예외 처리 - 오류 상황 관리
- [ ] 76 자원 해제 - 파일 저장/로드
...
# 2주차 추가 개념 학습 적용: 리팩토링 및 기능 추가
- [30 확장 함수 적용하기](/309c12b2b4e6e97ff100ac2829df52d4c22f9797)
